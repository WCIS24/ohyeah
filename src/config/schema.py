...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "qexpand": {
        ...
        "boost": 0.15,
        "seed_top_k": 5,
        "abbrev": {"enabled": True, "dict_path": None},
        "prf_year": {"enabled": True},
    },
    "eval": {
        "k_list": [1, 5, 10],
...
SCHEMA_TYPES: Dict[str, Tuple[type, ...]] = {
    ...
    "calculator.tasks.enable_lookup": (bool,),
    ...
    "calculator.selective.enabled": (bool,),
    "calculator.selective.pre_gate.enabled": (bool,),
    "calculator.selective.pre_gate.tau_need": (float, int),
    "calculator.selective.pre_gate.negative_intent.enabled": (bool,),
    "calculator.selective.pre_gate.negative_keywords": (list,),
    "calculator.selective.pre_gate.positive_keywords": (list,),
    "calculator.selective.evidence_gate.enabled": (bool,),
    "calculator.selective.evidence_gate.strict_year": (bool,),
    "calculator.selective.evidence_gate.require_unit_consistency": (bool,),
    "calculator.selective.evidence_gate.min_operands": (dict,),
    "calculator.selective.evidence_gate.min_operands.yoy": (int,),
    "calculator.selective.evidence_gate.min_operands.diff": (int,),
    "calculator.selective.evidence_gate.min_operands.share": (int,),
    "calculator.selective.evidence_gate.min_operands.multiple": (int,),
    "calculator.selective.evidence_gate.min_operands.lookup": (int,),
    "calculator.selective.post_gate.enabled": (bool,),
    "calculator.selective.post_gate.share_range": (list,),
    "calculator.selective.post_gate.yoy_abs_max": (float, int),
    "calculator.selective.post_gate.require_unit_ok": (bool,),
    "calculator.selective.lookup.require_explicit_year": (bool,),
    ...
    "qexpand": (dict,),
    "qexpand.enabled": (bool,),
    "qexpand.max_queries": (int,),
    "qexpand.boost": (float, int),
    "qexpand.seed_top_k": (int,),
    "qexpand.abbrev.enabled": (bool,),
    "qexpand.abbrev.dict_path": (str, type(None)),
    "qexpand.prf_year.enabled": (bool,),
    "eval.k_list": (list,),
